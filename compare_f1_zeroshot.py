...
# ---------- save CSVs ----------
combined_csv = os.path.join(args.output_dir, "chatgpt_zeroshot_f1_runs.csv")
summary_csv = os.path.join(args.output_dir, "chatgpt_zeroshot_f1_summary.csv")
...
plt.ylabel("F1")
plt.title("Chat GPT 4.1: Zero-Shot F1 Distribution Across Runs")
plt.ylim(0, 1)
boxplot_path = os.path.join(args.output_dir, "chatgpt_zeroshot_f1_boxplot.png")
...
plt.xlabel("Run")
plt.ylim(0, 1)
plt.title("Chat GPT 4.1 Zero-Shot Prompting: F1 Across  Runs")
lineplot_path = os.path.join(args.output_dir, "chatgpt_zeroshot_f1_line.png")
plt.tight_layout()
...
plt.ylim(0, 1)
plt.ylabel("F1")
plt.title(f"Zero-Shot Mean F1 with {int(args.ci)}% CI: Chat GPT 4.1")
ci_plot_path = os.path.join(args.output_dir, "chatgpt_zeroshot_f1_mean_ci.png")
